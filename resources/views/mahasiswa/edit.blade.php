  ...
  <div class="max-w-xl mx-auto mt-10 bg-white p-6 rounded shadow">
    ...
    <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST">
      ...
      <div class="mb-4">
        ...
        <input type="text" name="nim" class="border rounded w-full p-2" value="{{ old('nim', $mahasiswa->nim) }}">
      </div>

      <div class="mb-4">
        <label class="block font-semibold mb-2">Nama</label>
        <input type="text" name="nama" class="border rounded w-full p-2" value="{{ old('nama', $mahasiswa->nama) }}">
      </div>

      <div class="mb-4">
        <label class="block font-semibold mb-2">Prodi</label>
        <input type="text" name="prodi" class="border rounded w-full p-2" value="{{ old('prodi', $mahasiswa->prodi) }}">
      </div>
